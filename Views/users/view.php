            ...
            <form action="view.php" method="POST" novalidate>
                ...
                <input type="email" id="email" name="email" placeholder="Your e-mail is..."><br>
                ...
                <label for="tags">Favorite tags:</label><br>
                <textarea id="tags" name="subject" placeholder="Add some tags... one space between each tag "
                          style="height:50px"></textarea><br>
